//package com.logicalReplication;
//
...
//
//	public Snapshot(String publication) {
//		this.publication = publication;
//	}
//
//	public Snapshot(Connection sqlConnection, String publication) {
...
//	{
//		PreparedStatement stmt = this.sqlConnection.prepareStatement(
...
//	{
//		PGConnection pgcon = this.sqlConnection.unwrap(PGConnection.class);
//		ByteArrayOutputStream out = new ByteArrayOutputStream();
//
//		CopyManager manager = pgcon.getCopyAPI();
//		manager.copyOut(
//				"COPY (SELECT REGEXP_REPLACE(ROW_TO_JSON(t)::TEXT, '\\\\\\\\', '\\\\', 'g') FROM (SELECT * FROM "
//						+ tableName + ") t) TO STDOUT ", out);
//
...
//
//				snapshot.add("{\"snapshot\":{\"relationName\":\"" + table + "\",\"tupleData\":"
